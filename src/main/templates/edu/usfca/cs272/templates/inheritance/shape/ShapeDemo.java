...
public class ShapeDemo {
	public static void main(String[] args) {
		...
		Rectangle r1 = null;
		// System.out.printf(ROW, "r1", r1.getClass().getSimpleName(), r1.hashCode(), r1.getName(), r1.toString(), r1.area());

		Rectangle r2 = null;
		// System.out.printf(ROW, "r2", r2.getClass().getSimpleName(), r2.hashCode(),r2.getName(), r2.toString(), r2.area());

		Rectangle r3 = null;
		// System.out.printf(ROW, "r3", r3.getClass().getSimpleName(), r3.hashCode(), r3.getName(), r3.toString(), r3.area());

		Square q1 = null;
		// System.out.printf(ROW, "q1", q1.getClass().getSimpleName(), q1.hashCode(), q1.getName(), q1.toString(), q1.area());
